...
class CommandsControllerTest < ActionController::TestCase
  ...
  test "should create command" do
    assert_difference('Command.count') do
      post :create, command: { compile_command: @command.compile_command, description: @command.description, name: @command.name }
    end
  ...
  test "should update command" do
    put :update, id: @command, command: { compile_command: @command.compile_command, description: @command.description, name: @command.name }
    assert_redirected_to command_path(assigns(:command))
  end
